...
namespace namespace06 {
    ...
    let phillipPlainJacket: Artikel = {
    ...
    let airJordanBLUEBLACK: Artikel = {
    ...
    for (let index: number = 0; index < artikel.length; index++) {
        ...
        let newImg: HTMLImgElement = document.createElement("img");     //Bild
