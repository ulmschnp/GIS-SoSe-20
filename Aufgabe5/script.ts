...
let phillipPlainJacket: Special = {
...
let nike90offwhite: SpecialShoes = {
...
let airJordanBLUEBLACK: SpecialShoes = {
...
let nikebacktofuture: SpecialShoes = {
...
for (let zahl: number = 0; zahl < specialedition.length; zahl++) {
    ...
    let content: HTMLParagraphElement = document.createElement("p");    //Beschreib.
    ...
    let einkaufen: HTMLButtonElement = document.createElement("button"); //Kaufen
...
for (let zahl: number = 0; zahl < shoes.length; zahl++) {
    ...
    let kaufen: HTMLButtonElement = document.createElement("button");    //Einkaufswagen
